...
def parse_args():
    ...
    parser.add_argument('--cache', default=False, action='store_true', help='Whether to cache image features or compute on the fly')
    
    parser.add_argument('--mode', type=str, choices=['baseline', 'efficient', 'k_only', 'k_lsh', 'k_ee', 'mue'])
