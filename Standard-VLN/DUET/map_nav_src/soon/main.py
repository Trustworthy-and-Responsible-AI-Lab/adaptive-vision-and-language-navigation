...
def build_dataset(args, rank=0, is_test=True):
    ...
    if args.aug is not None:
        ...
        aug_env = dataset_class(
            feat_db, obj_db, aug_instr_data, args.connectivity_dir, img_db_file, args,
            ...
            multi_endpoints=args.multi_endpoints, multi_startpoints=args.multi_startpoints, cache=args.cache
        )
    else:
        aug_env = None
    ...
    train_env = dataset_class(
        feat_db, obj_db, train_instr_data, args.connectivity_dir, img_db_file, args,
        batch_size=args.batch_size, max_objects=args.max_objects,
    ...
    for split in val_env_names:
        ...
        val_env = dataset_class(
            feat_db, obj_db, val_instr_data, args.connectivity_dir, img_db_file, args, batch_size=args.batch_size,
            angle_feat_size=args.angle_feat_size, seed=args.seed+rank,
            sel_data_idxs=None if args.world_size < 2 else (rank, args.world_size), name=split,
            max_objects=None, multi_endpoints=False, multi_startpoints=False, is_train=False, cache=args.cache
