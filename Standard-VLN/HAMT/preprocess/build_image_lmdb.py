...
lmdb_path = os.path.join(os.getenv('PANOS_DIR'), 'clean/panoimages.lmdb')

env = lmdb.open(lmdb_path, map_size=int(1e12))

for i, viewpoint_id in tqdm(enumerate(viewpoint_ids), total=len(viewpoint_ids), desc="Processing viewpoints"):
