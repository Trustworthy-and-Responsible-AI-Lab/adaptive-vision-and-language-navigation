...
def build_dataset(args, rank=0, is_test=False):
    ...
    train_env = dataset_class(
        feat_db, obj_db, train_instr_data, args.connectivity_dir, args.img_db_file, args.anno_dir, args,
    ...
    if args.aug is not None:
        ...
        aug_env = dataset_class(
            feat_db, obj_db, aug_instr_data, args.connectivity_dir, args.img_db_file, args.anno_dir, args, batch_size=args.batch_size, 
            angle_feat_size=args.angle_feat_size, seed=args.seed+rank,
    ...
    for split in val_env_names:
        ...
        val_env = dataset_class(
            feat_db, obj_db, val_instr_data, args.connectivity_dir, args.img_db_file, args.anno_dir, args, batch_size=args.batch_size, 
            angle_feat_size=args.angle_feat_size, seed=args.seed+rank,
...
def valid(args, train_env, val_envs, rank=-1):
    ...
    txt = f"average GFLOPs: {sum(layer_count.gflopss)/len(layer_count.gflopss)}\n"
