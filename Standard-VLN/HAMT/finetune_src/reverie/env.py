...
class ReverieNavBatch(R2RBatch):
    def __init__(self, feat_db, instr_data, connectivity_dir, img_db_file, anno_dir, args,
        batch_size=64, angle_feat_size=4, seed=0, name=None, sel_data_idxs=None,
        multi_endpoints=False, multi_startpoints=False, cache=False):
        super().__init__(feat_db, instr_data, connectivity_dir, img_db_file, args, batch_size=batch_size,
...
class ReverieNavRefBatch(R2RBatch):
    def __init__(self, feat_db, obj_db, instr_data, connectivity_dir, img_db_file, anno_dir, args,
        batch_size=64, angle_feat_size=4, seed=0, name=None, sel_data_idxs=None,
        multi_endpoints=False, multi_startpoints=False, max_objects=20, cache=False):
        super().__init__(feat_db, instr_data, connectivity_dir, img_db_file, args, batch_size=batch_size,
            angle_feat_size=angle_feat_size, seed=seed, name=name, sel_data_idxs=sel_data_idxs, cache=cache)
