...
from utils.misc import length2mask, DATASET_TO_MAX_INSTRUCTIONS
...
class Seq2SeqBackAgent(Seq2SeqCMTAgent):
    ...
    def test(self, use_dropout=False, feedback='argmax', allow_cheat=False, iters=None, max_processed=100000):
    ...
    def rollout(self, train_ml=None, train_rl=True, reset=True):
        ...
        txt_embeds, lan_flops, params = profile(self.vln_bert, inputs=language_inputs)
        ...
        for t in range(self.args.max_action_len):
            ...
            t_outputs, vis_flops, params = profile(self.vln_bert, inputs=visual_inputs)
            ...
            t_hist_embeds, hist_flops, params = profile(self.vln_bert, inputs=t_hist_inputs)
